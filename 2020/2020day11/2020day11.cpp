...
int main() {
	...
	seatLayout.loadSeats("data.txt");
	cout << "Occupied Seats" << endl << seatLayout.occupiedSeats() << endl;
	cout << "Occupied Seats w/ Tolerance" << endl << seatLayout.occupiedSeatsWithTolerance() << endl;
